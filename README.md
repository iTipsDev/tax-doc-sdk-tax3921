...
Software development kit to generate IRS Form 3921 as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax3921.sample.png" width="850"/>
