...
import irs.fdxtax641.jsonserializers.Tax3921Serializer;
import irs.fdxtax641.map2objects.Map2Tax3921;
import org.taxdataexchange.core.pdfbuilders.Tax3921PdfBuilder;
...
public class Tax3921DocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax3921 obj = Map2Tax3921.generate( row );
        {
            String asJson = Tax3921Serializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax3921.csv";
        ...
        String outputFileName = "Tax3921.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax3921DocumentGenerator generator = new Tax3921DocumentGenerator( );
